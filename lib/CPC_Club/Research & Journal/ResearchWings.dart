...
class ResearchAndJournal extends StatefulWidget {
  const ResearchAndJournal({Key? key}) : super(key: key);

  @override
  State<ResearchAndJournal> createState() => _ResearchAndJournalState();
}

class _ResearchAndJournalState extends State<ResearchAndJournal> {
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      "About Research And Journal Wings",
                      style: TextStyle(
                        color: Color(0xff03438C),
                        fontWeight: FontWeight.bold,
                        fontSize: 20,
